...
+ If you're planning to implement a new feature it makes sense to discuss your changes on the [dev list](https://commons.apache.org/mail-lists.html) first. This way you can make sure you're not wasting your time on something that isn't considered to be in Apache Commons Jelly's scope.
...
+ Create a _topic branch_ for your isolated work.
  ...
  * A good topic branch name can be the JIRA bug id plus a keyword, for example, `JELLY-123-InputStream`.
